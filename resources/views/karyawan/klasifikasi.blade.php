...
@section('content')
    ...
    <div class="head mt-5">
        <div class="flex gap-5 justify-between items-center">
            <div class="heading">
                <h2 class="text-2xl font-bold tracking-tighter">Export Karyawan</h2>
                <div class="breadcrumb">
                    ...
                    <i class="ti ti-circle-filled text-theme-primary"></i>
                    <a href="#" class="text-sm text-gray-500 font-bold">Export Karyawan</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table text-center cell-border stripe" id="table_export"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 60px;">
                                        Nama</th>
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 60px;">
                                        Jabatan</th>
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 50px;">
                                        Kantor</th>
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 25px;">
                                        Gol
                                    </th>
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 65px;">
                                        Tanggal<br> Lahir</th>
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 35px;">
                                        Umur</th>
                                    ...
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 40px;">
                                        Status</th>
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 65px;">
                                        Tanggal<br> Mulai</th>
                        ...
                        <table class="table text-center cell-border stripe" id="table_export"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 100px;">
                                        Nama</th>
                                    <th
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        style="background-color: #CCD6A6; text-align: center; font-size: 11px; min-width: 40px;">
                                        Masa<br> Kerja</th>
                                    <th style="background-color: #CCD6A6; text-align: center; font-size: 11px;">Gaji<br>
                                        Pokok</th>
                                    ...
                                    <th style="background-color: #CCD6A6; text-align: center; font-size: 11px;">Total<br>
                                        Gaji</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($karyawan as $item)
                                    @if ($item->tanggal_penonaktifan === null)
                                        @php
                                            $tKeluarga = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Keluarga')
                                                ->first();

                                            $tListrik = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Telpon, Air dan Listrik')
                                                ->first();

                                            $tJabatan = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Jabatan')
                                                ->first();

                                            $tTeller = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Teller')
                                                ->first();

                                            $tPerumahan = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Perumahan')
                                                ->first();

                                            $tKesejahteraan = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Kesejahteraan')
                                                ->first();

                                            $tKemahalan = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Kemahalan')
                                                ->first();

                                            $tPelaksana = $item->tunjangan
                                                ->filter(fn($t) => $t->nama_tunjangan == 'Pelaksana')
                                                ->first();
                                        @endphp
                                        <tr>
                                            <td>{{ $item->nip }}</td>
                                            ...
                                            @php
                                                $totalGaji =
                                                    $item->gj_pokok +
                                                    $tKeluarga?->pivot->nominal +
                                                    $tListrik?->pivot->nominal +
                                                    $tJabatan?->pivot->nominal +
                                                    $tTeller?->pivot->nominal +
                                                    $tPerumahan?->pivot->nominal +
                                                    $tKesejahteraan?->pivot->nominal +
                                                    $tKemahalan?->pivot->nominal +
                                                    $tPelaksana?->pivot->nominal +
                                                    $item->gj_penyesuaian;
                                            @endphp
...
@section('custom_script')
    ...
    <script>
        ...
        function hitungTotalGaji() {
            ...
            var tGaji = $('#table_export').DataTable().column(15, {
                page: 'current'
            }).data()
            ...
            var tGaji = $('#table_export').DataTable().column(16, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var tGaji = $('#table_export').DataTable().column(17, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var totalTTeller = 0;
            var tGaji = $('#table_export').DataTable().column(18, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var totalTTelepon = 0;
            var tGaji = $('#table_export').DataTable().column(19, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var totalTJabatan = 0;
            var tGaji = $('#table_export').DataTable().column(20, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var tGaji = $('#table_export').DataTable().column(21, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var tGaji = $('#table_export').DataTable().column(22, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var tGaji = $('#table_export').DataTable().column(23, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var tGaji = $('#table_export').DataTable().column(24, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            var tGaji = $('#table_export').DataTable().column(25, {
                page: 'current'
            }).data()
            for (let i = 0; i < tGaji.length; i++) {
                const gaji = tGaji[i].replaceAll(',', '');
            ...
            buttons: [{
                    ...
                    title: function() {
                        ...
                        if (selectedValueCategory === "Keseluruhan" || selectedValueCategory === "Umur" ||
                            ...
                            } else if (selectedValueCategory === "Kantor" || selectedValueCategory ===
                                "Gaji") {
                    ...
                    customize: function(xlsx, row) {
                        ...
                        sheet.childNodes[0].childNodes[1].innerHTML = r1 + sheet.childNodes[0].childNodes[1]
                            .innerHTML;
                    }
                },
                {
